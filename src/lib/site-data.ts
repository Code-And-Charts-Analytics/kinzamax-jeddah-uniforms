...
export const images = {
  heroPolo: "/images/hero-polo.jpg",
  heroKnolling: heroKnolling.url,
  lineup: "/images/garment-lineup.jpg",
  stitch: stitch.url,
  badge: badge.url,
  flatlay: flatlay.url,
  factory: "/images/factory-floor.jpg",
  chefJacket: "/images/product-chef-jacket.jpg",
  hivisVest: hivisVest.url,
  labCoat: labCoat.url,
  securityJacket: securityJacket.url,
  stitchTriple: "/images/stitch-triple-macro.jpg",
  kmaxLabel: kmaxLabel.url,
  nurseScrubs: "/images/lifestyle-nurse-scrubs.jpg",
